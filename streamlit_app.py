...
def filename_to_partno(s):
    try:
        x = re.search(r"((?:\d|X|\.|[A-Z]){5})(?:-|_)((?:\d|X|\.|[A-Z]){4})(?:-|_)((?:\d|X|\.|[A-Z]){3})(?:-|_|__|--|\s+)?((?:\d|X|\.|[A-Z]){2})(?:-|_|__|--|\s+)?(?:REV)?(?:-|_|__|--|\s+)?((?:[A-Z]|\d)(?:[A-Z]|\d)?)(?:-|_|__|--|\s+|\Z)?", s)
        if x == None:
            x = re.search(r"((?:\d|X|\.|[A-Z]){5})(?:-|_)((?:\d|X|\.|[A-Z]){4})(?:-|_)((?:\d|X|\.|[A-Z]){3})(?:-|_|__|--|\s+)?(?:-|_|__|--|\s+)?(?:REV)?(?:-|_|__|--|\s+)?((?:[A-Z]|\d)(?:[A-Z]|\d)?)(?:-|_|__|--|\s+|\Z)?", s)
